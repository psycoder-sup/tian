...
description: Technical spec format, file location, and conventions established for tian project specs.
type: project
---

Milestone specs live at: docs/feature/tian/specs/m{N}-{feature-slug}-spec.md
Feature specs live at: docs/feature/{feature-slug}/{feature-slug}-spec.md (co-located with PRD)

Examples:
- docs/feature/tian/specs/m7-daily-driver-polish-spec.md
