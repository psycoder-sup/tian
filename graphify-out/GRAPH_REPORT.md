...
## Summary
- 4407 nodes · 11551 edges · 235 communities (162 shown, 73 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1652 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e4d85165`
...
Cohesion: 0.06
Nodes (14): SessionGitContext, Session, Bool, CGSize, ClaudeSessionState, Date, Int, URL (+6 more)
...
Cohesion: 0.10
Nodes (29): ParsableCommand, ActivityBegin, ActivityClear, ActivityEnd, ActivityGroup, ActivityReconcile, ActivityResetLifecycle, ActivitySync (+21 more)

### Community 6 - "Git Repo Watcher"
Cohesion: 0.05
Nodes (20): RemoteExecutionRegistry, Bool, SSHConnection, State, connected, connecting, idle, offline (+12 more)
...
Cohesion: 0.11
Nodes (17): CaseIterable, ExpressibleByArgument, handleListResponse(), PaneList, SessionList, IPCValue, WorkspaceList, WorktreeCreate (+9 more)

### Community 10 - "Config Auto-Set Runner"
Cohesion: 0.11
Nodes (21): Decodable, AutoSetPayload, ClaudeResultEnvelope, Bool, ClaudeInvoker, ProcessClaudeInvoker, URL, ConfigAutoSetResult (+13 more)
...
Cohesion: 0.22
Nodes (6): WorkspaceProviding, Any, Void, WorktreeOrchestrator, MockWorkspaceProvider, WorktreeOrchestratorTests
...
Cohesion: 0.07
Nodes (33): Codable, CopyEntry, SetupEntry, IPCEnv, IPCError, IPCRequest, IPCResponse, IPCValue (+25 more)
...
Cohesion: 0.08
Nodes (16): PaneState, exited, running, spawnFailed, UInt32, PaneViewModel, Bool, CGSize (+8 more)
...
Cohesion: 0.13
Nodes (5): CopyRule, Int, Int32, WorktreeServiceTests, WorktreeServiceTestsRunner

### Community 22 - "Refresh Scheduling & Coalescing"
Cohesion: 0.07
Nodes (28): ghostty_action_color_change_s, ghostty_action_s, ghostty_app_t, ghostty_clipboard_e, ghostty_config_t, ghostty_surface_config_s, ghostty_target_s, NSPasteboard (+20 more)
...
Cohesion: 0.06
Nodes (34): GitRepoID, GitRepoStatus, PRStatus, URL, CacheEntry, CacheKey, CacheResult, hit (+26 more)
...
Cohesion: 0.07
Nodes (18): CFTimeInterval, CallbackBox, GitRepoWatcher, Bool, DispatchQueue, escaping, FSEventStreamRef, Void (+10 more)
...
Cohesion: 0.06
Nodes (26): MarkdownContent, MarkdownUI, FileBaseline, committed, notInRepo, untracked, ReaderFileSource, RemoteReaderFileSource (+18 more)
...
Cohesion: 0.08
Nodes (26): CustomStringConvertible, Error, InspectChildEntry, NotificationError, permissionDenied, RestoreError, emptySessions, emptyWorkspaces (+18 more)
...
Cohesion: 0.06
Nodes (41): Identifiable, GitCommit, GitCommitGraph, GitDiffHunk, GitDiffLine, GitDiffSummary, GitFileStatus, added (+33 more)

### Community 50 - "Inspect File Scanner"
Cohesion: 0.14
Nodes (10): GitChangedFile, InspectIgnoredEntries, Set, BlockingScanner, FixedScanner, InspectFileTreeViewModel, InspectFileTreeViewModelTests, State (+2 more)
...
Cohesion: 0.22
Nodes (3): Observation, Keys, BranchEntry.Kind

### Community 76 - "Session Restorer Tests"
Cohesion: 0.12
Nodes (25): Equatable, Sendable, PaneKind, claude, terminal, PaneLeafState, PaneNode, PaneNodeState (+17 more)

### Community 77 - "Worktree Config Execution"
Cohesion: 0.13
Nodes (6): GitStatusService, escaping, Int, Int32, T, GitStatusServiceTests
...
Cohesion: 0.06
Nodes (32): Carbon.HIToolbox, KeyAction, closeWorkspace, cycleFocusArea, focusSidebar, goToSession, newSession, newWorkspace (+24 more)
...
Cohesion: 0.18
Nodes (7): ArgumentParser, ConfigAutoSet, ConfigGroup, Bool, CommandContext, TianCLI, Open
...
Cohesion: 0.11
Nodes (18): SessionSplitNavigation, CGRect, CGSize, PaneNode, UUID, Target, SessionContentView, Bool (+10 more)
...
Cohesion: 0.16
Nodes (10): BranchListViewModel, BranchRow, Direction, down, up, Mode, existingBranch, newBranch (+2 more)

### Community 125 - "WorktreeKindTests"
Cohesion: 0.15
Nodes (5): ClaudeSessionState, PaneNode, RemoteSpawnSpec, PaneSpawner, PaneViewModelRealizeSurfaceTests
...
Cohesion: 0.09
Nodes (18): Double, ForegroundProcessSummary, ClosedRange, Int32, SessionDividerClamper, Bool, CGFloat, SessionDividerView (+10 more)
...
Cohesion: 0.14
Nodes (15): Hashable, FileTreeNode, Kind, directory, file, Bool, Int, Kind (+7 more)
...
Cohesion: 0.04
Nodes (33): SwiftUI, SettingsView, InspectPanelFileBrowser, InspectFileTreeViewModel, Void, InspectPanelRail, CGFloat, Void (+25 more)
...
Cohesion: 0.08
Nodes (19): WorktreeError, baseWithExisting, branchAlreadyExists, closeInFlight, configParseError, gitError, invalidBaseRef, notAGitRepo (+11 more)
...
### Community 214 - "T"
Cohesion: 0.07
Nodes (31): Binding, S, DebugOverlayView, LabeledMetric, DiffBinaryPlaceholderRow, DiffFileHeaderRow, DiffHunkHeaderRow, DiffLineRow (+23 more)

### Community 246 - "SidebarWorkspaceHeaderView"
Cohesion: 0.33
...
- **Why does `String` connect `Git Types` to `IPC Command Handling`, `Terminal Surface Input`, `Session Git & PR Status`, `Session State Migration`, `CLI Command Router`, `Git Repo Watcher`, `SwiftUI View Components`, `Config Auto-Set Runner`, `Session Overview Grid`, `Worktree Orchestrator`, `Split Tree Model`, `SSH Remote Execution`, `ANSI Stripper`, `Workspace Model`, `Persistence State Models`, `Command Logger`, `Workspace Collection`, `Refresh Scheduling & Coalescing`, `Off-Main Process Runner`, `Decision Record Schema`, `Session State Fixtures`, `Worktree Service Tests`, `Workspace Reorder Logic`, `Inspect File Tree ViewModel`, `Error Types`, `Ghostty App Core`, `Pane Status Manager`, `Session Git Context Tests`, `Sidebar Drag Reorder`, `Session Migration Encoding Tests`, `Background Activity Store`, `Graphify Pipeline Skill`, `Session Divider Drag`, `Framework Imports`, `Markdown Reader`, `Worktree Config Parser`, `Session Audit Analyzer`, `Working Tree Watcher`, `Branch Graph Rendering`, `Inspect File Scanner`, `CLI Output Formatting`, `Claude Session State`, `Remote Connection & Workspace Create`, `Inspect Branch ViewModel`, `Ghostty Terminal Surface`, `Branch List Tests`, `IPC Client CLI`, `Create Session View`, `IPC Message Protocol`, `Session Split Navigation`, `Fuzzy Match`, `Worktree Setup Progress`, `Background Activity Sync`, `Pane Node Tree`, `Create Session Flow Tests`, `IPC Env Encoding`, `Pane Status Aggregation Tests`, `Session Restorer`, `Session Restorer Tests`, `Worktree Config Execution`, `Quit Flow Coordinator`, `Key Binding Registry`, `Session Content View`, `App Delegate Lifecycle`, `Window Drag Blocker`, `Commit Graph Tests`, `IPC Message Tests`, `Skill Installer`, `Branch List ViewModel`, `Branch List Service`, `Key Chord Model`, `Process Detector`, `Status Doc Schema`, `Image Reader`, `Session Serializer`, `Check For Updates`, `Working Directory Resolver`, `Shipped Items Schema`, `Status Bar View`, `NotificationManager`, `TianSettings`, `KeyboardLayoutTranslator`, `items`, `EnvironmentBuilderTests`, `WorktreeKindTests`, `SessionSplitNavigation`, `Response`, `MockWorkspaceProvider`, `BusyDotView`, `.makeHarness`, `InlineRenameView`, `os`, `RefreshSchedulerTests`, `resolve_from_runlog`, `SidebarWorkspaceHeaderView`, `WorktreeConfig`, `.fromIPCError`, `.startClaude`, `AppMetrics`, `EventCoalescerTests`, `.unifiedDiff`, `ConfirmAlert`, `ImageFileType`, `T`, `Field`?**
  _High betweenness centrality (0.535) - this node is a cross-community bridge._
- **Why does `Foundation` connect `Test Harness Utilities` to `Split Layout & Navigation`, `Session State Migration`, `CLI Command Router`, `Response`, `Git Repo Watcher`, `MockWorkspaceProvider`, `SwiftUI View Components`, `Config Auto-Set Runner`, `Session Overview Grid`, `blockingAwait`, `.stopPreventsFurtherCallbacks`, `Split Tree Model`, `SSH Remote Execution`, `Session Model`, `ANSI Stripper`, `Workspace Model`, `Command Logger`, `BranchListService`, `Refresh Scheduling & Coalescing`, `Off-Main Process Runner`, `PaneState`, `Git Status Service`, `Session State Fixtures`, `HtmlFileType`, `Inspect File Tree ViewModel`, `SidebarWorkspaceHeaderView`, `Error Types`, `Ghostty App Core`, `Pane Status Manager`, `WorktreeConfig`, `.fromIPCError`, `.startClaude`, `Background Activity Store`, `GitRepoWatcherBranchGraphTests`, `Session Divider Drag`, `Markdown Reader`, `Worktree Config Parser`, `EventCoalescerTests`, `Git Types`, `Branch Graph Rendering`, `Inspect File Scanner`, `CLI Output Formatting`, `Claude Session State`, `Markdown Diff Segments`, `Ghostty Terminal Surface`, `Branch List Tests`, `ConfirmAlert`, `Git Status Service Tests`, `IPC Message Protocol`, `Background Activity Sync`, `ImageFileType`, `Pane Node Tree`, `Create Session Flow Tests`, `Pane Status Aggregation Tests`, `Session Restorer`, `Session Restorer Tests`, `Quit Flow Coordinator`, `Key Binding Registry`, `File Log Writer`, `Window Drag Blocker`, `Commit Graph Tests`, `Remote Command Builder`, `Branch List ViewModel`, `Branch List Service`, `Process Detector`, `Status Doc Schema`, `Workspace Keyboard Navigation`, `Check For Updates`, `Working Directory Resolver`, `TianSettings`, `Row`, `KeyboardLayoutTranslator`, `socklen_t`, `items`, `WorktreeKindTests`, `SessionSplitNavigation`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `Session` connect `Session Git & PR Status` to `IPC Command Handling`, `implement`, `Git Repo Watcher`, `MockWorkspaceProvider`, `Sidebar Container`, `Split Tree Model`, `Inspect File Tree Scanning`, `Persistence State Models`, `Worktree Service Tests`, `Workspace Reorder Logic`, `Inspect File Tree ViewModel`, `Error Types`, `Pane Status Manager`, `.fromIPCError`, `Sidebar Drag Reorder`, `AppMetrics`, `NSView`, `Session Audit Analyzer`, `Git Types`, `EventCoalescerTests`, `Branch Graph Rendering`, `CLI Output Formatting`, `Session Restorer Tests`, `Quit Flow Coordinator`, `IPC Server Socket`, `T`, `Image Reader`, `Session Serializer`, `Workspace Keyboard Navigation`, `AutoSetPrompt`, `SidebarExpandedContentView`, `WorktreeKindTests`?**
