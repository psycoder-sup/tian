# Graph Report - skill-install-tian-only  (2026-07-13)

## Corpus Check
- 330 files · ~344,040 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4362 nodes · 11341 edges · 252 communities (170 shown, 82 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 1552 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0295f272`
...
Cohesion: 0.07
Nodes (8): JSONDecoder, SessionMigrationV4ToV5Tests, SessionMigrationV5ToV6Tests, SessionMigrationV7ToV8Tests, PaneNodeConversionTests, PaneNodeStateEncodingTests, RestoreCommandPaneViewModelTests, WindowFrameTests
...
Cohesion: 0.22
Nodes (6): Any, Void, WorktreeOrchestrator, MockWorkspaceProvider, OrchestratorTestError, WorktreeOrchestratorTests
...
Cohesion: 0.07
Nodes (23): PaneState, exited, running, spawnFailed, UInt32, PaneStatus, UInt64, PaneViewModel (+15 more)
...
Cohesion: 0.09
Nodes (6): SessionOverviewOverlayModifier, Bool, UUID, Void, WorkspaceCollection, WorkspaceCollectionTests
...
Cohesion: 0.10
Nodes (9): PaneStatusManager, ClaudeSessionState, Duration, Never, Set, Task, Void, PaneStatusManagerTests (+1 more)
...
Cohesion: 0.10
Nodes (8): BackgroundActivity, Bool, Date, TimeInterval, Bool, UUID, BackgroundActivityLifecycleTests, TimeInterval
...
Cohesion: 0.05
Nodes (49): CustomStringConvertible, Error, LocalizedError, CLIError, closeInFlight, connection, general, permissionDenied (+41 more)
...
Cohesion: 0.11
Nodes (32): Equatable, Identifiable, Sendable, escaping, T, GitCommit, GitCommitGraph, GitDiffHunk (+24 more)
...
Cohesion: 0.12
Nodes (13): CopyRule, LayoutNode, pane, split, ClosedRange, Int, SplitDirection, TimeInterval (+5 more)
...
Cohesion: 0.28
Nodes (7): SkillInstaller, String, URL, SkillInstallerTests, String, URL, UserDefaults
...
Cohesion: 0.14
Nodes (11): GridItem, CardEntry, KeyView, OverviewKeyboardResponder, SessionOverviewGridView, Bool, CGFloat, Int (+3 more)
...
Cohesion: 0.08
Nodes (18): WorkspaceProviding, Bool, UUID, WorktreeCreateResult, WorktreeError, baseWithExisting, branchAlreadyExists, closeInFlight (+10 more)
...
Cohesion: 0.09
Nodes (14): PaneKind, claude, terminal, ClaudeSessionState, PaneNode, RemoteSpawnSpec, SessionSplitNavigation, CGRect (+6 more)
...
Cohesion: 0.14
Nodes (8): FileBaseline, committed, notInRepo, untracked, GitStatusService, Bool, Int, Int32
...
Cohesion: 0.05
Nodes (26): SwiftUI, SettingsView, InspectPanelFileBrowser, InspectFileTreeViewModel, Void, InspectPanelRail, CGFloat, Void (+18 more)
...
Cohesion: 0.12
Nodes (8): SessionCloseFlow, Bool, NSWindow, URL, Bool, Int32, URL, WorktreeService
...
Cohesion: 0.19
Nodes (4): CLIError, WorkingDirectoryResolver, Bool, WorktreeRemovalResult
...
### Community 244 - "DebugOverlayView"
Cohesion: 0.33
Nodes (3): DebugOverlayView, LabeledMetric, Timer

### Community 245 - "InspectPanelTabRow"
Cohesion: 0.33
...
- **Why does `String` connect `Git Types` to `IPC Command Handling`, `Session Git & PR Status`, `Session State Migration`, `CLI Command Router`, `Git Repo Watcher`, `SwiftUI View Components`, `Config Auto-Set Runner`, `Session Overview Grid`, `Sidebar Container`, `Worktree Orchestrator`, `Split Tree Model`, `SSH Remote Execution`, `ANSI Stripper`, `Workspace Model`, `Persistence State Models`, `Command Logger`, `Workspace Collection`, `Refresh Scheduling & Coalescing`, `Off-Main Process Runner`, `Decision Record Schema`, `Session State Fixtures`, `Worktree Service Tests`, `Workspace Reorder Logic`, `Inspect File Tree ViewModel`, `Error Types`, `Ghostty App Core`, `Pane Status Manager`, `Session Git Context Tests`, `Sidebar Drag Reorder`, `Session Migration Encoding Tests`, `Background Activity Store`, `Graphify Pipeline Skill`, `Session Divider Drag`, `Framework Imports`, `Markdown Reader`, `Worktree Config Parser`, `Session Audit Analyzer`, `Working Tree Watcher`, `Branch Graph Rendering`, `Inspect File Scanner`, `CLI Output Formatting`, `Claude Session State`, `Remote Connection & Workspace Create`, `Inspect Branch ViewModel`, `Ghostty Terminal Surface`, `Branch List Tests`, `IPC Client CLI`, `Workspace Window Controller`, `Create Session View`, `IPC Message Protocol`, `Session Split Navigation`, `Fuzzy Match`, `Background Activity Sync`, `Pane Node Building`, `Pane Node Tree`, `Create Session Flow Tests`, `IPC Env Encoding`, `Pane Status Aggregation Tests`, `Session Restorer Tests`, `Worktree Config Execution`, `Quit Flow Coordinator`, `IPC Server Socket`, `Key Binding Registry`, `Session Content View`, `File Log Writer`, `Window Drag Blocker`, `Skill Installer`, `Branch List ViewModel`, `Branch List Service`, `Key Chord Model`, `Process Detector`, `Workspace Keyboard Navigation`, `Check For Updates`, `Working Directory Resolver`, `Shipped Items Schema`, `Status Bar View`, `NotificationManager`, `TianSettings`, `Row`, `KeyboardLayoutTranslator`, `implement-log`, `AutoSetPrompt`, `SidebarExpandedContentView`, `items`, `EnvironmentBuilderTests`, `WorktreeKindTests`, `SessionSplitNavigation`, `os`, `Response`, `BusyDotView`, `.makeHarness`, `InlineRenameView`, `RefreshSchedulerTests`, `resolve_from_runlog`, `GitStatusService`, `IPCMessageTests`, `SidebarWorkspaceHeaderView`, `StatusBarView`, `WorktreeConfig`, `.fromIPCError`, `.startClaude`, `AppMetrics`, `SessionRestorer`, `EventCoalescerTests`, `.unifiedDiff`, `PollingRefresher`, `ConfirmAlert`, `FalkorDB export`, `.from`, `T`, `DebugOverlayView`, `InspectPanelTabRow`, `InspectPanelStatusStrip`, `Kind`, `.claudePreviewText`?**
  _High betweenness centrality (0.567) - this node is a cross-community bridge._
- **Why does `Foundation` connect `Test Harness Utilities` to `IPC Command Handling`, `implement`, `Split Layout & Navigation`, `Session State Migration`, `CLI Command Router`, `Git Repo Watcher`, `os`, `Session Model`, `SwiftUI View Components`, `Config Auto-Set Runner`, `Session Overview Grid`, `blockingAwait`, `.stopPreventsFurtherCallbacks`, `Split Tree Model`, `ANSI Stripper`, `Workspace Model`, `Command Logger`, `BranchListService`, `Off-Main Process Runner`, `PaneState`, `Git Status Service`, `Session State Fixtures`, `Worktree Service Tests`, `HtmlFileType`, `GitRepoWatcherBranchGraphTests`, `Pane Status Manager`, `WorktreeConfig`, `.fromIPCError`, `.startClaude`, `Background Activity Store`, `Session Divider Drag`, `Markdown Reader`, `Worktree Config Parser`, `Git Types`, `Working Tree Watcher`, `Inspect File Scanner`, `CLI Output Formatting`, `Claude Session State`, `Markdown Diff Segments`, `Ghostty Terminal Surface`, `Workspace Window Controller`, `ConfirmAlert`, `PollingRefresher`, `IPC Message Protocol`, `FalkorDB export`, `Background Activity Sync`, `Pane Node Building`, `Worktree Setup Progress`, `Create Session Flow Tests`, `Pane Node Tree`, `Pane Status Aggregation Tests`, `Session Restorer Tests`, `Quit Flow Coordinator`, `Key Binding Registry`, `File Log Writer`, `T`, `Commit Graph Tests`, `IPC Message Tests`, `Remote Command Builder`, `Branch List ViewModel`, `Branch List Service`, `Process Detector`, `Workspace Keyboard Navigation`, `Check For Updates`, `Working Directory Resolver`, `TianSettings`, `Row`, `KeyboardLayoutTranslator`, `AutoSetPrompt`, `items`, `WorktreeKindTests`, `SessionSplitNavigation`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `TerminalSurfaceView` connect `NotificationManager` to `Terminal Surface Input`, `Session Git & PR Status`, `Split Layout & Navigation`, `Image Reader`, `Git Types`, `SSH Remote Execution`, `Persistence State Models`, `Branch List Fakes`, `App Delegate Lifecycle`, `Refresh Scheduling & Coalescing`, `WorktreeKindTests`, `.characterIndex`?**
