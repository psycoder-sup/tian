...
- WorktreeOrchestratorTests.swift
...
4. `Session` - 154 edges
5. `IPCCommandHandler` - 113 edges
6. `WorkspaceCollection` - 110 edges
7. `View` - 108 edges
8. `PaneViewModel` - 94 edges
9. `Workspace` - 93 edges
...
## Communities (263 total, 92 thin omitted)

### Community 0 - "IPC Command Handling"
Cohesion: 0.13
Nodes (8): IPCCommandHandler, Int, WindowCoordinator, IPCCommandHandlerTests, IPCEnv, IPCRequest, IPCValue, WorkspaceProviding
...
Cohesion: 0.07
Nodes (9): JSONDecoder, RemoteConnectionState, RemoteConnection, Bool, RemoteConnectionTests, SessionMigrationV4ToV5Tests, SessionMigrationV5ToV6Tests, SessionMigrationV7ToV8Tests (+1 more)
...
Cohesion: 0.09
Nodes (15): PaneKind, claude, terminal, PaneViewModel, Bool, CGSize, ClaudeSessionState, NSObjectProtocol (+7 more)
...
Cohesion: 0.06
Nodes (42): Codable, Equatable, Sendable, CopyEntry, SetupEntry, IPCEnv, WorktreeKind, linkedWorktree (+34 more)

### Community 28 - "Worktree Service Tests"
Cohesion: 0.11
Nodes (6): PaneStatusManager, Duration, Never, Void, PaneStatusManagerTests, UUID
...
Cohesion: 0.09
Nodes (10): Bool, Date, URL, UUID, Workspace, WorkspaceSnapshot, DefaultWorkingDirectoryTests, MainActor (+2 more)
...
Cohesion: 0.12
Nodes (10): GitRepoWatcher, FSEventStreamRef, RepoLocation, CallbackTracker, GitRepoWatcherTests, PathRecorder, StringError, Bool (+2 more)
...
Cohesion: 0.08
Nodes (22): MarkdownContent, MarkdownUI, ReaderFileSource, RemoteReaderFileSource, DiffColors, MarkdownDiffView, Rendered, Int (+14 more)
...
Cohesion: 0.08
Nodes (30): CustomStringConvertible, Error, Logger, ScannerError, decodeFailed, NotificationError, permissionDenied, RestoreError (+22 more)
...
Cohesion: 0.17
Nodes (7): InspectFileScanner, gitFailed, Bool, Data, Int32, URL, InspectFileScannerTests
...
Cohesion: 0.06
Nodes (24): App, IPCServer, Notification, NSApplication, NSApplicationDelegate, NSObject, PaneViewModel, Scene (+16 more)
...
Cohesion: 0.16
Nodes (11): ContinuousClock, Double, Duration, Never, Task, ProcessCPUMonitor, Bool, Int (+3 more)
...
Cohesion: 0.13
Nodes (11): ClaudeSessionNotifier, Bool, ClaudeSessionState, Duration, UUID, ClaudeSessionState, NotificationManager, Bool (+3 more)
...
Cohesion: 0.07
Nodes (21): ghostty_input_mods_e, NSAttributedString, NSMenu, NSPoint, NSRange, NSRangePointer, NSRect, NSSize (+13 more)
...
Cohesion: 0.09
Nodes (20): Double, ClosedRange, AppMetrics, Int, UInt64, Snapshot, Bool, Duration (+12 more)
...
Cohesion: 0.14
Nodes (7): Observation, Keys, Bool, UserDefaults, TianSettings, UserDefaults, TianSettingsTests
...
Cohesion: 0.03
Nodes (36): SwiftUI, SettingsView, InspectPanelFileBrowser, InspectFileTreeViewModel, Void, InspectPanelRail, CGFloat, Void (+28 more)
...
Cohesion: 0.07
Nodes (24): Log, Bool, UUID, WorktreeCreateResult, WorktreeError, baseWithExisting, branchAlreadyExists, closeInFlight (+16 more)
...
Cohesion: 0.09
Nodes (6): AppKit, CoreGraphics, CGRect, WindowFrame, DirectoryPicker, URL
...
### Community 214 - "T"
Cohesion: 0.05
Nodes (38): Binding, S, DebugOverlayView, LabeledMetric, DiffBinaryPlaceholderRow, DiffFileHeaderRow, DiffHunkHeaderRow, DiffLineRow (+30 more)

### Community 242 - "CacheResult"
Cohesion: 0.50
...
## Knowledge Gaps
- **436 isolated node(s):** `Target`, `Split Tree`, `Working Directory Resolution`, `Lifecycle`, `Source Layout` (+431 more)
...
- **Why does `String` connect `Git Types` to `IPC Command Handling`, `Terminal Surface Input`, `Session Git & PR Status`, `Session State Migration`, `CLI Command Router`, `Git Repo Watcher`, `Session Model`, `SwiftUI View Components`, `Config Auto-Set Runner`, `Session Overview Grid`, `Worktree Orchestrator`, `Split Tree Model`, `SSH Remote Execution`, `Inspect File Tree Scanning`, `ANSI Stripper`, `Workspace Model`, `Persistence State Models`, `Command Logger`, `Workspace Collection`, `Refresh Scheduling & Coalescing`, `Off-Main Process Runner`, `Decision Record Schema`, `Session State Fixtures`, `Worktree Service Tests`, `Inspect File Tree ViewModel`, `Error Types`, `Ghostty App Core`, `Pane Status Manager`, `Session Git Context Tests`, `Sidebar Drag Reorder`, `Session Migration Encoding Tests`, `Background Activity Store`, `Graphify Pipeline Skill`, `Framework Imports`, `Markdown Reader`, `Worktree Config Parser`, `Session Audit Analyzer`, `Working Tree Watcher`, `Branch Graph Rendering`, `Inspect File Scanner`, `CLI Output Formatting`, `Claude Session State`, `Remote Connection & Workspace Create`, `Inspect Branch ViewModel`, `Ghostty Terminal Surface`, `Branch List Tests`, `IPC Client CLI`, `Create Session View`, `IPC Message Protocol`, `Session Split Navigation`, `Fuzzy Match`, `Pane Node Building`, `Pane Node Tree`, `Create Session Flow Tests`, `IPC Env Encoding`, `Pane Status Aggregation Tests`, `Session State Registry`, `Session Restorer`, `Session Restorer Tests`, `Worktree Config Execution`, `Quit Flow Coordinator`, `IPC Server Socket`, `Key Binding Registry`, `Session Content View`, `Window Drag Blocker`, `Commit Graph Tests`, `IPC Message Tests`, `Skill Installer`, `Branch List ViewModel`, `Key Chord Model`, `Process Detector`, `Status Doc Schema`, `Close Confirmation Dialog`, `Image Reader`, `Working Directory Resolver`, `Shipped Items Schema`, `Status Bar View`, `NotificationManager`, `TianSettings`, `Row`, `KeyboardLayoutTranslator`, `AutoSetPrompt`, `SidebarExpandedContentView`, `items`, `EnvironmentBuilderTests`, `SessionSplitNavigation`, `Response`, `BusyDotView`, `Response`, `InlineRenameView`, `RefreshSchedulerTests`, `resolve_from_runlog`, `PaneState`, `SessionSplitNavigation`, `GitRepoWatcherBranchGraphTests`, `SidebarWorkspaceHeaderView`, `.fromIPCError`, `.startClaude`, `AppMetrics`, `NSView`, `EventCoalescerTests`, `.init`, `NSViewRepresentable`, `ConfirmAlert`, `GitFileStatus`, `DebugOverlayView`, `ImageFileType`, `T`, `WorktreeRemovalResult`, `InspectPanelStatusStrip`, `OrchestratorTestError`, `.tail`, `.requestSessionClose`?**
  _High betweenness centrality (0.545) - this node is a cross-community bridge._
- **Why does `Session` connect `Session Git & PR Status` to `Terminal Surface Input`, `Git Repo Watcher`, `MockWorkspaceProvider`, `Sidebar Container`, `Split Tree Model`, `Inspect File Tree Scanning`, `Persistence State Models`, `Session State Fixtures`, `Worktree Service Tests`, `Workspace Reorder Logic`, `Inspect File Tree ViewModel`, `.fromIPCError`, `Sidebar Drag Reorder`, `Session Divider Drag`, `.makeEmptyWorkspace`, `Session Audit Analyzer`, `Git Types`, `Branch Graph Rendering`, `CLI Output Formatting`, `Ghostty Terminal Surface`, `GitFileStatus`, `Worktree Setup Progress`, `Pane Node Tree`, `Session State Registry`, `IPC Server Socket`, `T`, `Session Serializer`, `Workspace Keyboard Navigation`, `Check For Updates`, `Row`, `socklen_t`, `SidebarExpandedContentView`, `.requestSessionClose`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `Foundation` connect `Test Harness Utilities` to `Terminal Surface Input`, `Split Layout & Navigation`, `Session State Migration`, `CLI Command Router`, `Git Repo Watcher`, `Session Model`, `SwiftUI View Components`, `Config Auto-Set Runner`, `Session Overview Grid`, `blockingAwait`, `.stopPreventsFurtherCallbacks`, `Split Tree Model`, `SSH Remote Execution`, `Inspect File Tree Scanning`, `ANSI Stripper`, `Workspace Model`, `Persistence State Models`, `Command Logger`, `BranchListService`, `Off-Main Process Runner`, `Decision Record Schema`, `Git Status Service`, `Session State Fixtures`, `PaneState`, `HtmlFileType`, `GitRepoWatcherBranchGraphTests`, `Pane Status Manager`, `.fromIPCError`, `Background Activity Store`, `PollingRefresher`, `Markdown Reader`, `Worktree Config Parser`, `Session Audit Analyzer`, `Git Types`, `EventCoalescerTests`, `Inspect File Scanner`, `CLI Output Formatting`, `Claude Session State`, `Markdown Diff Segments`, `Ghostty Terminal Surface`, `IPC Client CLI`, `NSViewRepresentable`, `ConfirmAlert`, `GitFileStatus`, `Worktree Setup Progress`, `ImageFileType`, `Pane Node Building`, `Create Session Flow Tests`, `Pane Status Aggregation Tests`, `WorkspaceProviding`, `Session Restorer Tests`, `Quit Flow Coordinator`, `IPC Server Socket`, `Key Binding Registry`, `File Log Writer`, `Window Drag Blocker`, `Commit Graph Tests`, `Remote Command Builder`, `Branch List ViewModel`, `Branch List Service`, `Status Doc Schema`, `Image Reader`, `Workspace Keyboard Navigation`, `Working Directory Resolver`, `Status Bar View`, `.requestSessionClose`, `TianSettings`, `KeyboardLayoutTranslator`, `WorktreeOrchestratorTests.swift`, `AutoSetPrompt`, `WorktreeRemovalResult`, `items`, `EnvironmentBuilderTests`, `SessionSplitNavigation`?**
...
- **Are the 61 inferred relationships involving `IPCCommandHandler` (e.g. with `.activitySyncInvalidPaneUUIDReturnsError()` and `.activitySyncMissingJsonReturnsError()`) actually correct?**
  _`IPCCommandHandler` has 61 INFERRED edges - model-reasoned connections that need verification._